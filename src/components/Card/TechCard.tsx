        ...
        {tech.map((item, i) => (
          <div
            ...
            className={cn(
              ...
              item === "Nest Js" && "border border-blue-500/60",
              item === "Next Auth" && "border border-red-500/60",
              item === "Typescript" && "border border-blue-500/60",
              item === "Material UI" && "border border-emerald-500/60",
              item === "HTML" && "border border-green-500/60",
              item === "CSS" && "border border-blue-500/60",
              item === "Next Js 14" && "border border-red-500/60",
              item === "Jenkins" && "border border-gray-500/60",
              item === "Sonar" && "border border-red-500/60",
              item === "JIRA" && "border border-green-500/60",
              item === "PLANE" && "border border-blue-500/60"
            )}
          >
            {item}
          </div>
